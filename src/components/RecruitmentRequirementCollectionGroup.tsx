...
export function RecruitmentRequirementCollectionGroup({ onNavigate }: { onNavigate?: (page: string) => void }) {
              ...
              <div className="bg-white min-h-full p-8 shadow-sm rounded-sm flex flex-col">
                 ...
                 <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="flex items-center justify-between mb-4 shrink-0 flex-wrap gap-4">
                       ...
                       <div className="flex items-center gap-2">
                          <button className="px-4 py-1 border border-gray-400 text-gray-700 hover:bg-gray-50 text-sm">校招组提交</button>
                          <button className="px-4 py-1 border border-gray-400 text-gray-700 hover:bg-gray-50 text-sm">校招组驳回</button>
