...
export function RecruitmentApprovalCompany({ onNavigate }: { onNavigate?: (page: string) => void }) {
          ...
          {activeTab === 'details' && (
            <div>
              <div className="mb-4 flex justify-between items-center">
                <button className="px-4 py-1.5 border border-gray-400 rounded-sm text-sm text-gray-600 bg-white font-medium">一级部门</button>
              ...
              <table className="w-full text-sm text-center border-collapse">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="py-3 font-bold text-gray-700">一级部门</th>
                    ...
                    <tr key={id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-4">
                        <button 
                          ...
                          onClick={() => onNavigate && onNavigate("校招审批单-一级部门")}
                        >
                          查看详情
                        </button>
                      </td>
