...
export function RecruitmentRequirementCollectionPM({ onNavigate }: { onNavigate?: (page: string) => void }) {
  // Mock data matching the screenshot
  const data = [
    { id: 1, dept: '部门1', processNo: '', deptCount: 2, currentCount: 6, recentCount: 12, posCount: 5, totalCount: 23, nineStars: 3, campus: 20, intern: 0, status: '校招PM未提交', submitter: '姓名1', approver: '姓名1', operation: '详情', isRed: true },
    { id: 2, dept: '部门2', processNo: '', deptCount: 2, currentCount: 6, recentCount: 12, posCount: 7, totalCount: 21, nineStars: 20, campus: 1, intern: 0, status: '已完成', submitter: '姓名2', approver: '姓名2', operation: '详情', isRed: false },
    { id: 3, dept: '部门3', processNo: '', deptCount: 5, currentCount: 6, recentCount: 12, posCount: 8, totalCount: 57, nineStars: 0, campus: 0, intern: 57, status: '主BP审核中', submitter: '姓名3', approver: '姓名3', operation: '详情', isRed: false },
    { id: 4, dept: '部门4', processNo: '', deptCount: 6, currentCount: 7, recentCount: 3, posCount: 9, totalCount: 86, nineStars: 46, campus: 40, intern: 0, status: '一级部门负责人审批中', submitter: '姓名4', approver: '姓名4', operation: '详情', isRed: false },
    { id: 5, dept: '部门5', processNo: '', deptCount: 4, currentCount: 7, recentCount: 21, posCount: 4, totalCount: 45, nineStars: 20, campus: 20, intern: 5, status: '已完成', submitter: '姓名5', approver: '姓名5', operation: '详情', isRed: false },
    { id: 6, dept: '部门6', processNo: '', deptCount: 5, currentCount: 8, recentCount: 1, posCount: 12, totalCount: 65, nineStars: 35, campus: 30, intern: 0, status: '已完成', submitter: '姓名6', approver: '姓名6', operation: '详情', isRed: false },
    { id: 7, dept: '部门7', processNo: '', deptCount: 1, currentCount: 9, recentCount: 8, posCount: 11, totalCount: 12, nineStars: 0, campus: 0, intern: 12, status: '已完成', submitter: '姓名7', approver: '姓名7', operation: '详情', isRed: false },
    { id: 8, dept: '部门8', processNo: '', deptCount: 1, currentCount: 9, recentCount: 5, posCount: 1, totalCount: 8, nineStars: 2, campus: 4, intern: 2, status: '已完成', submitter: '姓名8', approver: '姓名8', operation: '详情', isRed: false },
  ];
                 ...
                 <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="flex items-center justify-between mb-4 shrink-0 flex-wrap gap-4">
                       <div className="flex items-center gap-4 text-sm">
                          <div className="flex items-center gap-2">
                             <span className="text-gray-600">一级部门</span>
                       ...
                       <div className="flex items-center gap-2">
                          <button className="px-4 py-1 border border-gray-400 text-gray-700 hover:bg-gray-50 text-sm">校招PM提交</button>
                       ...
                       <table className="w-max min-w-full text-xs text-center border-collapse">
                          <thead className="bg-[#FAFAFA] sticky top-0 z-10">
                             <tr>
                                ...
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">一级部门</th>
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">校招流程单号<br/>二阶段</th>
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">实际需求部门数</th>
                                ...
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">招聘岗位数</th>
                                ...
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">状态</th>
                          ...
                          <tbody>
                             {data.map((row) => (
                                <tr key={row.id} className="hover:bg-gray-50">
                                   ...
                                   <td className="border-r border-b border-gray-200 py-3 px-2 text-gray-600 whitespace-nowrap">{row.dept}</td>
                                   <td className="border-r border-b border-gray-200 py-3 px-2 text-gray-600 whitespace-nowrap">{row.processNo}</td>
                                   <td className="border-r border-b border-gray-200 py-3 px-2 text-gray-600 whitespace-nowrap">{row.deptCount}</td>
