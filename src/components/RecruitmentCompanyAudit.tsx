           ...
           <div className="flex-1 px-6 pb-6 overflow-y-auto">
              <div className="bg-white min-h-full p-8 shadow-sm rounded-sm">
                 ...
                 <div className="mb-8">
                    ...
                    <div className="flex flex-col gap-4 text-xs text-gray-700 whitespace-nowrap">
                 ...
                 {/* Section 2: Recruitment Audit */}
                 <div>
                    <div className="flex items-center justify-between mb-4 border-b border-gray-100 pb-2">
                       <div className="flex items-center gap-2 border-l-4 border-[#1890FF] pl-2">
                          <span className="text-[#1890FF] font-medium text-lg">校招审核</span>
                       </div>
                       <div className="flex items-center gap-1 text-gray-500 cursor-pointer text-sm">
                          收起 <ChevronUp size={16} />
                       </div>
                    ...
                    <table className="w-full text-xs text-center border-collapse border-b border-gray-200 whitespace-nowrap">
                       <thead className="bg-[#F5F5F5]">
                          <tr>
                             <th className="py-3 font-normal text-gray-700">校招流程单号-三阶段</th>
                             <th className="py-3 font-normal text-gray-700">提交人</th>
                             <th className="py-3 font-normal text-gray-700">提交时间</th>
                             <th className="py-3 font-normal text-gray-700">状态</th>
                             <th className="py-3 font-normal text-gray-700">当前审批人</th>
                          </tr>
                       </thead>
                       <tbody>
                          <tr>
                             <td className="py-3 text-gray-700">XZ20250607001</td>
                             <td className="py-3 text-gray-700">测试提交人</td>
                             <td className="py-3 text-gray-700">2025-07-08 ~ 17:38</td>
                             <td className="py-3 text-gray-700">审批中</td>
                             <td className="py-3 text-gray-700">审批人</td>
                          </tr>
                       </tbody>
                    </table>
                 </div>
