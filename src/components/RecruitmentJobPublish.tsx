...
export function RecruitmentJobPublish({ onNavigate }: { onNavigate?: (page: string) => void }) {
  ...
  const data = [
    { id: 1, position: '岗位1', dept: '实际部门1', fullPath: '一级部门/实际部门1', count: 23, type: '九号星', submitter: '测试01', status: '已取消', message: '', operation: '详情', isRed: true },
    { id: 2, position: '岗位2', dept: '实际部门2', fullPath: '一级部门/部门/实际部门2', count: 21, type: '九号星', submitter: '测试02', status: '发布成功', message: '', operation: '详情', isRed: false },
    { id: 3, position: '岗位3', dept: '实际部门3', fullPath: '一级部门/实际部门3', count: 57, type: '九号星', submitter: '测试03', status: '发布失败', message: '', operation: '详情', isRed: false },
    { id: 4, position: '岗位4', dept: '实际部门4', fullPath: '一级部门/实际部门4', count: 86, type: '校招生', submitter: '测试04', status: '未发布', message: '', operation: '详情', isRed: false },
    { id: 5, position: '岗位5', dept: '实际部门5', fullPath: '一级部门/实际部门5', count: 45, type: '校招生', submitter: '测试05', status: '发布成功', message: '', operation: '详情', isRed: false },
    { id: 6, position: '岗位6', dept: '实际部门6', fullPath: '一级部门/实际部门6', count: 65, type: '暑期实习项目', submitter: '测试06', status: '发布失败', message: '', operation: '详情', isRed: false },
    { id: 7, position: '岗位7', dept: '实际部门7', fullPath: '一级部门/实际部门7', count: 12, type: '暑期实习项目', submitter: '测试07', status: '未发布', message: '', operation: '详情', isRed: false },
  ];
              ...
              <div className="bg-white min-h-full p-8 shadow-sm rounded-sm flex flex-col">
                 ...
                 <div className="flex-1 flex flex-col overflow-hidden">
                    <div className="flex items-center justify-between mb-4 border-b border-gray-100 pb-2 shrink-0">
                       <div className="flex items-center gap-2 border-l-4 border-[#1890FF] pl-2">
                          <span className="text-[#1890FF] font-medium text-lg">校招发布</span>
                       </div>
                       <div className="flex items-center gap-1 text-gray-500 cursor-pointer text-sm">
                          收起 <ChevronUp size={16} />
                       </div>
                    ...
                    <div className="flex items-center justify-between mb-4 shrink-0 flex-wrap gap-4">
                       ...
                       <div className="flex items-center gap-2">
                          <button className="px-6 py-1 border border-gray-400 text-gray-700 hover:bg-gray-50 text-sm">发布</button>
                          <button className="px-6 py-1 border border-gray-400 text-gray-700 hover:bg-gray-50 text-sm">导出</button>
                       </div>
                    </div>
                       ...
                       <table className="w-full text-xs text-center border-collapse">
                          <thead className="bg-[#FAFAFA] sticky top-0 z-10">
                             <tr>
                                ...
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">岗位</th>
                                ...
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">岗位招聘人数</th>
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">人才类型</th>
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">单据提交人</th>
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">发布状态</th>
                                <th className="border-r border-b border-gray-200 py-3 px-2 font-normal text-gray-700 whitespace-nowrap">发布返回消息</th>
                          ...
                          <tbody>
                             {data.map((row) => (
                                <tr key={row.id} className="hover:bg-gray-50">
                                   ...
                                   <td className="border-r border-b border-gray-200 py-3 px-2 text-gray-600 whitespace-nowrap">{row.position}</td>
                                   ...
                                   <td className="border-r border-b border-gray-200 py-3 px-2 text-gray-600 whitespace-nowrap">{row.count}</td>
                                   <td className="border-r border-b border-gray-200 py-3 px-2 text-gray-600 whitespace-nowrap">{row.type}</td>
                                   ...
                                   <td className="border-r border-b border-gray-200 py-3 px-2 text-gray-600 whitespace-nowrap">{row.message}</td>
